...
const arrayChallenges: Challenge[] = [
  {
    ...
    translation: "Dado um array nums contendo n números distintos no intervalo [0, n], retorne o único número no intervalo que está faltando no array.",
    run: async () => {
    ...
    translation: "Dado um array de inteiros nums, retorne um array answer tal que answer[i] seja igual ao produto de todos os elementos de nums exceto nums[i].",
    run: async () => {
...
const linkedListChallenges: Challenge[] = [
  ...
  
  {
    ...
    translation: "Dado o nó inicial (head) de uma lista encadeada simples, retorne o nó do meio da lista. Se houver dois nós do meio, retorne o segundo nó do meio.",
    run: async () => {
